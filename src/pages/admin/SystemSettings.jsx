                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) => updateSetting('payment', 'enableStripe', e.target.checked)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateSetting('shipping', 'standardShippingRate', parseFloat(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        min="0"
                        step="0.01"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateSetting('shipping', 'internationalShippingRate', parseFloat(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        min="0"
                        step="0.01"
                      />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center">
                        ...
                        />
                        <span className="text-sm text-gray-700">Enable Free Shipping</span>
                      </label>
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={settings.shipping.enableExpressShipping}
                          onChange={(e) => updateSetting('shipping', 'enableExpressShipping', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-3"
                        />
                        <span className="text-sm text-gray-700">Enable Express Shipping</span>
                      </label>
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={settings.shipping.enableInternationalShipping}
                          onChange={(e) => updateSetting('shipping', 'enableInternationalShipping', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-3"
                        />
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <label className="flex items-center justify-between">
                        <span className="text-sm text-gray-700">Shipping Updates</span>
                        <input
                          type="checkbox"
