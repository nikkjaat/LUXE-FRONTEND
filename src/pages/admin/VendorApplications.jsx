...
const VendorApplications = () => {
  const { vendorApplications, approveApplication, rejectApplication } = useVendors();
                      ...
                      <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm text-gray-600">
                            <span className="font-medium">Owner:</span> {application.name}
                          </p>
                          <p className="text-sm text-gray-600">
                        ...
                        <div>
                          <p className="text-sm text-gray-600">
                            <span className="font-medium">Business Type:</span> {application.businessType}
                          </p>
                          <p className="text-sm text-gray-600">
