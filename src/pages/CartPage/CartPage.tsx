      ...
      <div className={styles.page}>
        <div className={styles.container}>
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyDescription}>Looks like you haven't added any items to your cart yet.</p>
                    ...
                    <div key={item.id} className={styles.cartItem}>
                      ...
                      <div className={styles.itemInfo}>
                        ...
                        <div className={styles.productOptions}>
                          {item.size && (
                            <span className={styles.optionText}>Size: {item.size}</span>
                          )}
                          {item.color && (
                            <span className={styles.optionText}>Color: {item.color}</span>
                          )}
                        </div>
            ...
            <div className={styles.summaryCard}>
              ...
              <div className={styles.summaryItems}>
                ...
                <div className={styles.summaryRow}>
                  ...
                  <span className={`${styles.summaryValue} ${styles.free}`}>Free</span>
                </div>
                <div className={styles.summaryRow}>
                  <span className={styles.summaryLabel}>Tax</span>
                  <span className={styles.summaryValue}>${(totalPrice * 0.08).toFixed(2)}</span>
                </div>
                <div className={`${styles.summaryRow} ${styles.summaryDivider}`}>
                  <div className={styles.summaryTotal}>
                    <span className={styles.totalLabel}>Total</span>
                    <span className={styles.totalValue}>${(totalPrice * 1.08).toFixed(2)}</span>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.features}>
                <div className={styles.feature}>
                  <Shield className={`${styles.featureIcon} ${styles.shield}`} />
