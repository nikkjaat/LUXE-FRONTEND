...
const ShopPage = () => {
  ...
  const [maxPrice, setMaxPrice] = useState(1000); // New state for dynamic max price
  ...
  // Function to calculate next hundred value
  const getNextHundred = (price) => {
    return Math.ceil(price / 100) * 100;
  };

  // Function to set dynamic price range based on products
              ...
              <div className={styles.filterSection}>
                ...
                <div className={styles.priceSection}>
                  ...
                  <input
                    type="range"
                    min="0"
                    max={maxPrice} // Using dynamic max price
                    value={priceRange[1]}
                    onChange={(e) =>
                  ...
                  <div key={product.id} className={styles.listCard}>
                    <div className={styles.listContent}>
                      <div className={styles.listImageContainer}>
                        ...
                        />
                        <div className={styles.listBadge}>{product.badge}</div>
                      </div>
                      ...
                      <div className={styles.listActions}>
                        ...
                        >
                          <Heart
                            className={`${styles.listWishlistIcon} ${
                              isInWishlist(product.id) ? styles.filled : ""
                            }`}
                          />
                        </button>
