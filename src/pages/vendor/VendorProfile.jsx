...
const VendorProfile = () => {
  ...
  const averageRating = vendorProducts.length > 0 
    ? vendorProducts.reduce((sum, p) => {
        const rating = typeof p.rating === 'object' ? p.rating.average : p.rating;
        return sum + (rating || 0);
              ...
              <div className="text-center mb-6">
                ...
                <div className="mt-2">
                  <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                    ...
                    {user?.vendorInfo?.status === 'approved' ? 'Verified Vendor' : 'Pending Approval'}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-lg">{formData.vendorInfo.shopName}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-lg">{formData.vendorInfo.businessType}</p>
                    )}
                  </div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-lg">
                        {formData.vendorInfo.website ? (
                          <a href={formData.vendorInfo.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700">
                            {formData.vendorInfo.website}
                          </a>
                        ) : (
                          'Not provided'
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="px-4 py-3 bg-gray-50 rounded-lg">
                      {formData.vendorInfo.description || 'No description provided'}
                    </p>
                  )}
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600 mb-2">{totalProducts}</div>
                  <div className="text-sm text-gray-600">Total Products</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">{activeProducts}</div>
                  <div className="text-sm text-gray-600">Active Products</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-600 mb-2">{averageRating.toFixed(1)}</div>
                  <div className="text-sm text-gray-600">Average Rating</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">{totalReviews}</div>
