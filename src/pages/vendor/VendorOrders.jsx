...
const VendorOrders = () => {
  ...
  // Calculate stats
  const totalRevenue = orders.reduce((sum, order) => sum + (order.vendorTotal || order.total || 0), 0);
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className={`px-2 py-1 rounded text-xs ${getStatusConfig(selectedOrder.status).bg} ${getStatusConfig(selectedOrder.status).text}`}>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">${(selectedOrder.vendorTotal || selectedOrder.total).toFixed(2)}</span>
                      </div>
