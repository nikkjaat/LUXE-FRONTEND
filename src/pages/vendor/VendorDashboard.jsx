...
const VendorDashboard = () => {
  ...
  const getStatusConfig = (status) => {
    const configs = {
      ...
      shipped: { bg: 'bg-purple-100', text: 'text-purple-800', icon: ShoppingBag, label: 'Shipped' },
      ...
      inactive: { bg: 'bg-red-100', text: 'text-red-800', icon: AlertTriangle, label: 'Inactive' }
    };
  ...
  const lowStockProducts = vendorProducts.filter(p => (p.stock || 0) < 10).length;
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-green-600">+{vendorAnalytics?.revenue?.growth || 0}% growth</p>
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {vendorProducts.slice(0, 6).map((product) => (
                    <div key={product._id} className="border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-500 mt-1">Stock: {product.stock || 0}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">+{vendorAnalytics?.revenue?.growth || 0}%</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{vendorAnalytics?.customers?.total || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{vendorAnalytics?.products?.views || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{vendorAnalytics?.customers?.satisfaction || 0}</p>
                  </div>
                </div>
              </div>
            </div>
